      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <span className="px-3 py-1 bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest rounded-md">3P CERTIFIED SYSTEM</span>
            <span className="px-3 py-1 bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest rounded-md">LEVEL: SUPERVISOR</span>
          </div>
          <div>
            <h1 className="text-4xl font-black text-slate-900 tracking-tight leading-none">Unit Performance Console</h1>
          ...
          <div className="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-100">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">TEAM VALIDATION QUEUE</h3>
                  <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest">PENDING APPROVALS</p>
                </div>
              </div>
              <button className="flex items-center gap-2 px-5 py-2.5 bg-blue-50 text-blue-600 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-100 transition-colors border border-blue-100">
              ...
              {[
                ...
                <div key={i} className="flex items-center justify-between p-5 bg-slate-50/40 rounded-[2rem] hover:bg-white hover:shadow-md transition-all border border-transparent hover:border-slate-100 group">
                  <div className="flex items-center gap-6">
                    <div className="w-14 h-14 rounded-3xl bg-white border border-slate-100 flex items-center justify-center text-xs font-black text-blue-600 shadow-sm">
                      <span className="text-emerald-500 font-black">{person.name.split(' ').map(n => n[0]).join('')}</span>
                    </div>
                    <div>
                      <p className="text-xs font-black text-slate-900">{person.name} {person.active && <span className="w-2 h-2 bg-amber-400 rounded-full inline-block ml-1"></span>}</p>
            ...
            <div className="space-y-16">
              ...
              <div className="space-y-5">
                <div className="flex justify-between items-end">
                  ...
                  <p className="text-3xl font-black text-emerald-400 tracking-tight">$16,016.4</p>
                </div>
